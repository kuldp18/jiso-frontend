...
const emotionCategories = [
  ...
  {
    name: "Neutral",
    icon: <Meh className="h-8 w-8 text-primary" />,
    emotions: [
          ...
          {selectedEmotions.length > 0 && (
            <div className="flex justify-end">
              <Button
                ...
                className="bg-gradient-to-r from-pink-500 to-primary/90 flex gap-2 text-primary-foreground"
              >
      ...
      return (
        <div className="space-y-6">
          <h2 className="text-xl font-semibold">
            What kind of {selectedCategory?.toLowerCase()} are you feeling?
          </h2>
          <p className="text-muted-foreground">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 flex justify-between">
          ...
          <Button
            ...
            className="flex gap-2 items-center min-w-[140px] text-primary-foreground"
